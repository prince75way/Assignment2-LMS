...
import { Menu as MenuIcon, Logout as LogoutIcon, Home as HomeIcon, LibraryBooks as LibraryBooksIcon, Close as CloseIcon, DashboardCustomize, PriorityHighOutlined } from "@mui/icons-material";
      ...
      >
        ...
        <List sx={{ padding: 0 }}>
          ...
          >
            ...
            <DashboardCustomize sx={{fontSize:24}}/>
            </ListItemIcon>
         ...
         { isAuthenticated && <ListItem
          ...
          >
            ...
            <PriorityHighOutlined sx={{fontSize:24}}/>
            </ListItemIcon>
